...
// Metodo responsável por add item de um array
...
// Método responsável para montar a url
// Removendo espaços e caracteres especiais
function prepararURL(palavra) {
...
function exibeErro(texto, btn, btnTxt = "Salvar") {
...
// formatar numeros, Adicionando K,M,B,T,Q
...
} // END >> Fun::formatNumero()



// Método responsável por deletar itens do banco de dados
function deletar(url, id, itemTabela)
{
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if(data.tipo == true)
            {
                ...
                $("#" + itemTabela + "_" + id).css("display","none");
