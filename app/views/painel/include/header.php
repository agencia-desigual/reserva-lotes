            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= BASE_URL; ?>quadra">
                        <i class="ni ni-map-big text-red"></i> Mapa
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="<?= BASE_URL; ?>negociacaoes">
                        <i class="ni ni-check-bold text-blue"></i> Negociações
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?= BASE_URL; ?>corretores">
                        <i class="ni ni-single-02 text-primary"></i> Corretores
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= BASE_URL; ?>cadastros-site">
                        <i class="ni ni-badge text-primary"></i> Contato Site
                    </a>
                </li>
                <div class="dropdown-divider"></div>
                <li class="nav-item">
                ...
                <span class="avatar avatar-sm rounded-circle">
                  <img alt="Image placeholder" src="<?= BASE_URL; ?>arquivos/assets/img/brand/perfil.jpg">
                            ...
                            <div class="media-body ml-2 d-none d-lg-block">
                                <span class="mb-0 text-sm  font-weight-bold"><?= explode(" ", $usuario->nome)[0]; ?> | Administrador</span>
                            </div>
                        </div>
                    </a>
                    <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
